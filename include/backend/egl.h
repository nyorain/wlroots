...
EGLImageKHR wlr_egl_create_image(struct wlr_egl *egl, EGLenum target,
	EGLClientBuffer buffer, const EGLint *attribs);

// Destroys an egl image created with the given wlr_egl.
void wlr_egl_destroy_image(struct wlr_egl *egl, EGLImageKHR image);
